...
values (1,0,'fahime@gmail.com','yarmohammadi','fahime','Fy123456','fahime@gmail.com','ACCEPTED','image/aa.jpg',20);

insert into expert(id,credit,email,family_name,name,password,username,expert_condition,path,score)
values (2,10000,'sara@gmail.com','kohan','sara','Sara1234','sara@gmail.com','ACCEPTED','image/aa.jpg',10);
